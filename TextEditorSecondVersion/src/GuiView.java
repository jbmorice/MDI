...
public class GuiView implements ApplicationView {
	...
	private void initialize() {
		...
		btnStartSelection.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				applicationController
						.setTextBufferStartSelectionIndex(applicationController.getTextBufferCaretPosition());
		...
		btnEndSelection.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				applicationController
						.setTextBufferEndSelectionIndex(applicationController.getTextBufferCaretPosition());
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				applicationController.deleteContentFromTextBuffer(
						applicationController.getTextBufferStartSelectionIndex(),
						applicationController.getTextBufferEndSelectionIndex());
				applicationController.resetTextBufferSelection();
			}
		});
		...
		btnUndo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(applicationController.isUndoPossibe()) {
		...
		btnRedo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(applicationController.isRedoPossibe()) {
	...
	private void updateCaretaker() {
		System.out.println(applicationController.isUndoPossibe() + " " + applicationController.isRedoPossibe());
		if(applicationController.isUndoPossibe()) {
